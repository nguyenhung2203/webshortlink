...
{
    /// <inheritdoc />
    public partial class InitialIdentityAndShortlink : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentPlanId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Domains_AppUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeatureValue = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClickLimit = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AbuseReports_AppUsers_ReportedByUserId",
                        column: x => x.ReportedByUserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AbuseReports_Links_LinkId",
                        column: x => x.LinkId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IpAddress = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    MaskedIp = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalClicks = table.Column<long>(type: "bigint", nullable: false),
                    UniqueClicks = table.Column<long>(type: "bigint", nullable: false),
                    BotClicks = table.Column<long>(type: "bigint", nullable: false),
                    SuspiciousClicks = table.Column<long>(type: "bigint", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedByUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedByUserId = table.Column<string>(type: "nvarchar(max)", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LinkDailyStats", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LinkDailyStats_Links_LinkId",
                        column: x => x.LinkId,
                        principalTable: "Links",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "LinkHourlyStats",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LinkId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    HourBucketUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TotalClicks = table.Column<long>(type: "bigint", nullable: false),
                    UniqueClicks = table.Column<long>(type: "bigint", nullable: false),
                    BotClicks = table.Column<long>(type: "bigint", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LinkHourlyStats", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LinkHourlyStats_Links_LinkId",
                        column: x => x.LinkId,
                        principalTable: "Links",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LinkRules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LinkRules_Links_LinkId",
                        column: x => x.LinkId,
                        principalTable: "Links",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbuseReports_LinkId_IsResolved",
                table: "AbuseReports",
                columns: new[] { "LinkId", "IsResolved" });

            migrationBuilder.CreateIndex(
                name: "IX_AbuseReports_ReportedByUserId",
                table: "AbuseReports",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUsers_CurrentPlanId",
                table: "AppUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_ActorType_CreatedAtUtc",
                table: "AuditLogs",
                columns: new[] { "ActorType", "CreatedAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClickEvents_ClickedAtUtc",
                table: "ClickEvents",
                column: "ClickedAtUtc");

            migrationBuilder.CreateIndex(
                name: "IX_ClickEvents_LinkId_ClickedAtUtc",
                table: "ClickEvents",
                columns: new[] { "LinkId", "ClickedAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LinkDailyStats_LinkId_StatDate",
                table: "LinkDailyStats",
                columns: new[] { "LinkId", "StatDate" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LinkHourlyStats_LinkId_HourBucketUtc",
                table: "LinkHourlyStats",
                columns: new[] { "LinkId", "HourBucketUtc" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LinkRules_LinkId_RuleType_Priority",
                table: "LinkRules",
                columns: new[] { "LinkId", "RuleType", "Priority" });

            migrationBuilder.CreateIndex(
                name: "IX_Links_DomainId_Slug",
                table: "Links",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Links_UserId_CreatedAtUtc",
                table: "Links",
