  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'checkout/:id', name: 'user-checkout', component: () => import('@/views/user/CheckoutView.vue') },
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'payments', name: 'admin-payments', component: () => import('@/views/admin/AdminPaymentsView.vue') },
        { path: 'domains', name: 'admin-domains', component: () => import('@/views/admin/AdminDomainsView.vue') },
