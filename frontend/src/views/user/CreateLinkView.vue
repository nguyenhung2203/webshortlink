...
import { Settings2, Link as LinkIcon, AlertCircle, Copy, CheckCircle2, ChevronDown, ChevronUp, Lock } from 'lucide-vue-next'
...
<template>
  <div class="ui-root" style="max-width: 800px;">
